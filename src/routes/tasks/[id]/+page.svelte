...
<div class="p-6 max-w-3xl space-y-6">
	<a
		href="/tasks"
		class="inline-flex items-center gap-2 text-sm font-mono text-chrome-400 hover:text-chrome-200"
	>
		<ArrowLeft size={16} />
		Back to Queue
	</a>
	...
	{:else if !task}
		<Card>
			<div class="py-12 text-center">
				...
				<a href="/tasks" class="text-rust-400 hover:text-rust-300 text-sm font-mono mt-2 inline-block">
					View all tasks
				</a>
			</div>
		</Card>
